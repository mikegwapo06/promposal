    ...
    <>
      ...
      <div className="flex flex-row justify-center items-center w-full h-full bg-pink-200 p-10 drop-shadow-xl">
        <div className="w-2/3 h-64 bg-gradient-to-r from-pink-300 to-pink-200 drop-shadow-xl rounded-full text-center transition-all duration-300">
          <h1 className="p-20 tracking-wide text-8xl font-bold text-white uppercase drop-shadow-lg">Helloooo</h1>
        </div>
      </div>

      <div className="flex flex-row items-center justify-evenly w-full h-96 bg-pink-50">
        <CommentedImage src='/hadi_new1.jpg' text="omggg langgg, we&apos;re so cuteee"/>
        <CommentedImage src='/hadi_new2.jpg' text="haysss, ganda mooo"/>
        <CommentedImage src='/hadi_new3.jpg' text="soft handsss"/>
      </div>

      <div className="text-center w-full h-64 bg-pink-200 drop-shadow-xl">
        <h1 className="p-20 tracking-wide text-6xl font-bold text-pink-400 uppercase drop-shadow-xl">So I heard from Kaykayy...</h1>
      </div>
      ...
      <div className="flex flex-row justify-around items-center text-center w-full h-96 bg-pink-50 p-5">
        <h1 className='w-2/3 text-pink-300 font-bold text-6xl'>Uhmmm</h1>
      </div>

      <CornyQuestion 
        question="Would you be the butt to my Red Guy, Rainnn hahaha?"
      ...
      <CornyQuestion 
        question="Would you be the smut to my Among Us, Sleepyheaddd?"
      ...
      <CornyQuestion 
        question="Would you be the banana to my Minion, langgg?"
